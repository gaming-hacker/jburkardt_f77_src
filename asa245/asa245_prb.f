...
c  Discussion:
c
c    ASA245_PRB tests the ASA245 library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST03 demonstrates the use of LGAMMA.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) '  LGAMMA is available with GFORTRAN.'  
      write ( *, '(a)' ) '  Compare the result to tabulated values.'
      write ( *, '(a)' ) ' '
      write ( *, '(a,a)' ) '          X                     ',
     &  'FX                        FX2'
      write ( *, '(a,a)' ) '                                ',
