...
c
      ...
      subroutine simplex_unit_monomial_integral ( dim_num, expon, value )

c*********************************************************************72
c
cc SIMPLEX_UNIT_MONOMIAL_INTEGRAL integrates a monomial over a simplex.
c
c  Discussion:
c
c    This routine evaluates a monomial of the form
...
c
      call simplex_unit_monomial_integral ( dim_num, expon, scale )
c
