...
c*********************************************************************72
c
cc Z_SAMPLE_HB is a sample FORTRAN90 calling program for SUPERLU.
c
c  Licensing:
c
...
c
      ...
      double complex acc(ncc_max)
      double complex b(n_max)
      double complex b2(n_max)
      integer ccc(n_max+1)
      integer factors(8)
      integer i
      integer icc(ncc_max)
...
c
      call zhbcode1 ( m, n, ncc, acc, icc, ccc )
...
c
c    Output, double complex ACC(NCC), the nonzero matrix acc.
c
