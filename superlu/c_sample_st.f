...
c*********************************************************************72
c
cc C_SAMPLE_ST calls SUPERLU to solve a system.
c
c  Licensing:
c
...
c    routine may be used to sort integers, complexs, numbers, names,
...
c
c    Input, complex AST(NST), the ST values.
c
...
c
c    Output, complex ACC(NCC), the CC values.
c
      implicit none
