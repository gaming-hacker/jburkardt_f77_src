...
c
      ...
      subroutine r8nsymm_gen ( n, lambda_mean, lambda_dev, seed, a, 
     &  ql, qr, lambda )

c*********************************************************************72
c
cc R8NSYMM_GEN generates a nonsymmetric matrix with a certain eigenstructure.
c
c  Discussion:
c
c    An R8NSYMM is a real nonsymmetric matrix stored using full storage, and
...
c
c    Output, double precision QL(N,N), the left eigenvector matrix.
c
c    Output, double precision QR(N,N), the right eigenvector matrix.
c
...
c
c  Get a random orthogonal matrices QL and QR.
c
      call r8mat_orth_uniform ( n, seed, ql )
      call r8mat_orth_uniform ( n, seed, qr )
c
c  Set A = QL * Lambda*I * QR'.
c
      do i = 1, n
        do j = 1, n
          a(i,j) = 0.0D+00
      ...
      subroutine r8symm_gen ( n, lambda_mean, lambda_dev, seed, a, 
     &  q, lambda )

c*********************************************************************72
c
cc R8SYMM_GEN generates a symmetric matrix with a certain eigenstructure.
c
c  Discussion:
c
