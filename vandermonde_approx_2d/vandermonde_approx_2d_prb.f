...
c*********************************************************************72
c
cc MAIN is the main program for VANDERMONDE_APPROX_2D_PRB.
c
c  Discussion:
c
c    VANDERMONDE_APPROX_2D_PRB tests the VANDERMONDE_APPROX_2D library.
c
c  Licensing:
c
...
c
      ...
      call timestamp ( )
      write ( *, '(a)' ) ''
      write ( *, '(a)' ) 'VANDERMONDE_APPROX_2D_PRB:'
