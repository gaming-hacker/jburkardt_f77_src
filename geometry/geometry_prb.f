...
c  Discussion:
c
c    GEOMETRY_PRB tests the GEOMETRY library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc ANGLE_BOX_2D_TEST tests ANGLE_BOX_2D.
c
c  Discussion:
c
c    Test 1:
...
c*********************************************************************72
c
cc ELLIPSE_AREA3_TEST tests ELLIPSE_AREA3.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST0351 tests LINE_PAR_POINT_NEAR_2D and LINE_PAR_POINT_DIST_2D.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*****************************************************************************80
c
cc TEST0352 tests LINE_PAR_POINT_DIST_3D and LINE_PAR_POINT_NEAR_3D.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc POLYGON_CONTAINS_POINT_2D_TEST tests POLYGON_CONTAINS_POINT_2D.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
     ...
     &  0.0D+00, 2.0D+00 /
      ...
      call r8mat_transpose_print ( dim_num, n, v, 
     &  '  The polygon vertices:' )
      ...
      do test = 1, test_num
        ...
        write ( *, '(2x,2g14.6,4x,l1)' ) 
     &    ( p(i), i = 1, dim_num ), inside
...
c*********************************************************************72
c
cc POLYGON_CONTAINS_POINT_2D_2_TEST tests POLYGON_CONTAINS_POINT_2D_2.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc POLYGON_CONTAINS_POINT_2D_3_TEST tests POLYGON_CONTAINS_POINT_2D_3.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
