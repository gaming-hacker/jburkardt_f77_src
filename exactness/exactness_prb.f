...
c*********************************************************************72
c
cc MAIN is the main program for EXACTNESS_PRB.
c
c  Discussion:
c
c    EXACTNESS_PRB tests the EXACTNESS library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 tests Gauss-Legendre rules for the Legendre integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST015 tests Fejer Type 1 rules for the Legendre integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST02 tests Fejer Type 2 rules for the Legendre integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST03 tests Clenshaw-Curtis rules for the Legendre integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST04 tests Gauss-Laguerre rules for the Laguerre integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST05 tests Gauss-Laguerre rules for the Laguerre integral with rho=1.
c
c  Discussion:
c
c    Instead of the usual density rho(x)=exp(-x), these rules apply to
c    approximating the integral:
c      I(f) = integral ( 0 <= x .lt. +oo ) f(x) dx
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c  Standardize the rule by multiplying every weight w(i) by exp(-x(i)).
c
        do i = 1, n
          w(i) = exp ( - x(i) ) * w(i)
        end do
c
c  Now test the rule in standard form.
c
        p_max = 2 * n
        call laguerre_exactness ( n, x, w, p_max )
...
c*********************************************************************72
c
cc TEST06 tests Gauss-Hermite rules for the Hermite integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST07 tests Gauss-Hermite rules for the Hermite integral.
c
c  Discussion:
c
c    Instead of the usual density rho(x)=exp(-x*x), these rules apply to
c    approximating the integral:
c      I(f) = integral ( -oo .lt. x .lt. +oo ) f(x) dx
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c  Standardize the rule by multiplying every weight w(i) by exp(-x(i)^2).
c
        do i = 1, n
          w(i) = exp ( - x(i) * x(i) ) * w(i)
        end do
...
c*********************************************************************72
c
cc TEST08 tests Gauss-Chebyshev1 rules for the Chebyshev1 integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST085 tests Gauss-Chebyshev3 rules for the Chebyshev1 integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST09 tests Gauss-Chebyshev2 rules for the Chebyshev2 integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) 'TEST09'
      write ( *, '(a)' ) 
     &  '  Gauss-Chebyshev1 rules for the Chebyshev2 integral.'
...
c    The integral:
c
c      integral ( -oo .lt. x .lt. +oo ) f(x) * rho(x) dx
c
