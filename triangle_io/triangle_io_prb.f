...
c*********************************************************************72
c
cc MAIN is the main program for TRIANGLE_IO_PRB.
c
c  Discussion:
c
c    TRIANGLE_IO_PRB tests the TRIANGLE_IO library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 gets the example node data and writes it to a file.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      double precision node_att(0,21)
      integer node_att_num
      double precision node_coord(2,21)
      integer node_dim
      character * ( 255 ) node_filename
      integer node_marker(1,21)
...
c
c  Get node example size.
c
      call triangle_node_size_example ( node_num, node_dim, 
...
c
      ...
      write ( *, '(a,i4)' ) 
     &  '  Number of node attributes = ', node_att_num
      write ( *, '(a,i4)' ) 
     &  '  Number of node markers = ', node_marker_num
c
c  Get the node data.
c
      call triangle_node_data_example ( node_num, node_dim, 
...
c
     ...
     &  1, 1, node_dim, 10, '  Coordinates for first 10 nodes:' )
      ...
      call r8mat_transpose_print_some ( node_att_num, node_num, 
     &  node_att, 1, 1, node_att_num, 10, 
     &  '  Attributes for first 10 nodes:' )

      call i4mat_transpose_print_some ( node_marker_num, node_num, 
     &  node_marker, 1, 1, node_marker_num, 10, 
     &  '  Markers for first 10 nodes:' )
c
c  Write the node information to node file.
c
      call triangle_node_write ( node_filename, node_num, node_dim, 
     &  node_att_num, node_marker_num, node_coord, node_att, 
     &  node_marker )

      write ( *, '(a)' ) ''
      write ( *, '(a)' ) '  Node data written to file "' // 
     &  trim ( node_filename ) // '"'
...
c*********************************************************************72
c
cc TEST02 gets the example element data and writes it to a file.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      double precision element_att(0,24)
...
c
      ...
      write ( *, '(a,i4)' ) '  Number of element attributes = ', 
     &  element_att_num
c
c  Get the data.
c
...
c
     ...
     &  '  Node connectivity of first 10 elements:' )
      ...
      call r8mat_transpose_print_some ( element_att_num, element_num, 
     &  element_att, 1, 1, element_att_num, 10, 
     &  '  Attributes for first 10 elements:' )
c
c  Write the node information to node file.
c
      call triangle_element_write ( element_filename, element_num, 
     &  element_order, element_att_num, element_node, element_att )

      write ( *, '(a)' ) ''
      write ( *, '(a)' ) '  Element data written to file "' // 
...
c*********************************************************************72
c
cc TEST03 reads the example node data from a file.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      write ( *, '(a)' ) ''
      write ( *, '(a)' ) '  Node data read from file "' // 
     &  trim ( node_filename ) // '"'
      write ( *, '(a)' ) ''
      write ( *, '(a,i4)' ) '  Number of nodes = ', node_num
      write ( *, '(a,i4)' ) '  Spatial dimension = ', node_dim
      write ( *, '(a,i4)' ) '  Number of node attributes = ', 
     &  node_att_num
      write ( *, '(a,i4)' ) '  Number of node markers = ', 
     &  node_marker_num
c
c  Get the data.
c
...
c*********************************************************************72
c
cc TEST04 reads the example element data from a file.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      write ( *, '(a)' ) ''
      write ( *, '(a)' ) '  Element data read from file "' // 
     &  trim ( element_filename ) // '"'
      write ( *, '(a)' ) ''
      write ( *, '(a,i4)' ) '  Number of elements = ', element_num
