...
c*********************************************************************72
c
cc MAIN is the main program for MINPACK_PRB.
c
c  Discussion:
c
c    MINPACK_PRB tests the MINPACK library.
c
c  Licensing:
c
...
c    'free' coefficients in the relationship we are trying to determine.
c
c    Thanks to Jacques Le Bourlot for pointing out that the line
c      integer fjrow
c    should instead read
c      double precision fjrow(n)
c    19 August 2016
c
c  Licensing:
c
