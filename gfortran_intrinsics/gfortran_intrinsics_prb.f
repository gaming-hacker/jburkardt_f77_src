...
c*********************************************************************72
c
cc MAIN is the main program for GFORTRAN_INTRINSICS_PRB.
c
c  Discussion:
c
c    GFORTRAN_INTRINSICS_PRB tests the GFORTRAN intrinsic library.
c
c  Licensing:
c
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'GFORTRAN_INTRINSICS_PRB'
      ...
      call timestamp ( )
c
c  Demonstrate one more intrinsic, the ABORT call.
c
      call test_abort
...
c*********************************************************************72
c
cc TEST_ABORT demonstrates the ABORT routine.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TEST_ABORT:'
      write ( *, '(a)' ) '  The ABORT routine causes program'
      write ( *, '(a)' ) '  termination, possibly with a core dump.'
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) '  It does set the error status flag that'
      write ( *, '(a)' ) '  can be detected by checking the $STATUS'
      write ( *, '(a)' ) '  environment variable.'
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) '  Presumably, this is the LAST demonstration!'

      call abort

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) '  If this message is printed, then ABORT'
      write ( *, '(a)' ) '  did not do its job.'
...
c*********************************************************************72
c
cc TEST_ALGAMA checks ALGAMA against GAMMA_LOG_VALUES.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc TEST_DGAMMA checks DGAMMA against GAMMA_VALUES.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc TEST_DLGAMA checks DLGAMA against GAMMA_LOG_VALUES.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc TEST_ETIME tests ETIME.
c
c  Discussion:
c
c    call etime ( tarray, result ) 
c
c    returns in the real array TARRAY(2) the user and system execution times
c    and in RESULT the run time since starting.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc TEST_GAMMA checks GAMMA against GAMMA_VALUES.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc TEST_ISNAN tests ISNAN.
c
c  Discussion:
c
c    ISNAN ( X ) is a logical function which is TRUE if the number X
c    is a "NaN", or "Not a Number".  This is a special value set to
c    indicate that an illegal argument was input to a function.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc TEST_SECNDS tests SECNDS.
c
c  Discussion:
c
c    The GFORTRAN function
c
c      integer function secnds ( t ) 
c
c    returns the current local time in seconds, since midnight, minus the
c    value of t.
c
c  Licensing:
c
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TEST_SECNDS'
      write ( *, '(a)' ) '  I = SECNDS ( T ) returns the local time,'
      write ( *, '(a)' ) '  in seconds, since midnight, minus T.'
      write ( *, '(a)' ) ' '
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) '  will compute the (wallclock) time elapsed'
      write ( *, '(a)' ) '  while stuff happens.'

      t = 0.0
      s = secnds ( t )
      write ( *, '(a)' ) ' '
      write ( *, '(a,f12.4,a,i8)' ) 
     &  '  Value returned by SECNDS ( ', t, ' ) = ', s
      t = real ( s )
      s = secnds ( t )
      write ( *, '(a,f12.4,a,i8)' ) 
     &  '  Value returned by SECNDS ( ', t, ' ) = ', s
