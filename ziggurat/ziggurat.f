...
c
c    Note that JSR and KE should actually be of unsigned integer type, but
c    this data type is not supported by FORTRAN77.
c
c  Licensing:
c
...
c  Discussion:
c
c    Note that KE should actually be of unsigned integer type, but
c    this data type is not supported by FORTRAN77.
c
c  Licensing:
c
...
c
c    Note that JSR and KN should actually be of unsigned integer type, but
c    this data type is not supported by FORTRAN77.
c
c  Licensing:
c
...
c  Discussion:
c
c    Note that JSR should actually be of unsigned integer type, but
c    this data type is not supported by FORTRAN77.
c
c  Licensing:
c
