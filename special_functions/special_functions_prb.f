...
c*********************************************************************72
c
cc MAIN is the main program for SPECIAL_FUNCTIONS_PRB.
c
c  Discussion:
c
c    SPECIAL_FUNCTIONS_PRB tests the SPECIAL_FUNCTIONS library.
c
c  Licensing:
c
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'MSPHJY'
      write ( *, '(a)' ) '  CSPHJY computes spherical Bessel functions'
      write ( *, '(a)' ) '  jn(z), yn(z) and their derivatives.'
      ...
      write ( *, '(a)' ) ''
      write ( *, '(a)' ) '  n      Re[jn(z)]        Im[jn(z)]',
     &  '        Re[jn''(z)]       Im[jn''(z)]'
      write ( *, '(a)' ) '--------------------------------------------',
     &  '----------------------------'
      do K = 0, NM, NS
        write ( *, '(1x,i3,4d17.8)' ) K, CSJ(K), CDJ(K)
      end do
      write ( *, '(a)' ) ''
      write ( *, '(a)' )'  n      Re[yn(z)]        Im[yn(z)]',
     &  '        Re[yn''(z)]       Im[yn''(z)]'
      write ( *, '(a)' )'--------------------------------------------',
     &  '----------------------------'
      do K = 0, NM, NS
        write ( *, '(1x,i3,4d17.8)' ) K, CSY(K), CDY(K)
      end do
...
c  Discussion:
c
c    This routine computes the spherical Bessel functions jn(x) and 
c    jn'(x) using SPHJ.
c
c  Example:
c
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'MSPHJ'
      write ( *, '(a)' ) '  SPHJ evaluates spherical Bessel J '
      write ( *, '(a)' ) '  functions'
