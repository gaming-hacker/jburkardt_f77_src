...
c
      ...
      do i = 1, n
        fx(i) = 2.0D+00 / ( 2.0D+00 + sin ( 10.0D+00 * r8_pi * x(i) ) )
      end do
...
c
      ...
      do i = 1, n
        ...
        fx(i) = 0.0D+00
        do j = 1, n_term
          fx(i) = fx(i) + cos ( 7.0D+00 ** j * r8_pi * x(i) ) 
     &      / 2.0D+00**j
        end do
...
c
      ...
      exact = atan ( ( 4.0D+00 - r8_pi ) 
     &  * 4.0D+00**( alpha - 1.0D+00 ) ) 
     &  + atan (             r8_pi   
     &  * 4.0D+00**( alpha - 1.0D+00 ) )
...
c
      ...
      do i = 1, n
        fx(i) = ( abs ( x(i) - 0.25D+00 * r8_pi ) ) ** alpha
      end do
...
c
      ...
      exact = r8_pi / 
     &  sqrt ( ( 1.0D+00 + 2.0D+00**(-alpha) )**2 - 1.0D+00 )
...
c
c    Input, character * ( * ) NAME, the name of the variable.
...
c
     ...
     &    + r8_lgmc ( y ) )
        ...
        r8_gamma = - r8_pi / ( y * sinpiy * r8_gamma )
