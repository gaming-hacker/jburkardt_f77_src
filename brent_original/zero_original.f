...
C     REAL FUNCTION ZERO ( A, B, MACHEP, T, F )
C     REAL A,B,MACHEP,T,F,SA,SB,C,D,E,FA,FB,FC,TOL,M,P,Q,R,S
      DOUBLE PRECISION FUNCTION ZERO ( A, B, MACHEP, T, F )
      DOUBLE PRECISION A,B,MACHEP,T,F,SA,SB,C,D,E,FA,FB,FC,TOL,M,P,Q,R,S
      SA = A
      SB = B
      FA = F(SA)
      FB = F(SB)
