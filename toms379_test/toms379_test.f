...
c*********************************************************************72
c
cc MAIN is the main program for TOMS379_TEST.
c
c  Discussion:
c
c    TOMS379_TEST tests TOMS379.
c
c  Modified:
c
c    02 January 2019
...
c
      ...
      call timestamp ( )
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TOMS379_TEST'
      write ( *, '(a)' ) '  FORTRAN77 version'
      write ( *, '(a)' ) '  Test TOMS379.'
...
c
c  Repeat the tests for 4 levels of error tolerance.
c
      do i = 1, 4
