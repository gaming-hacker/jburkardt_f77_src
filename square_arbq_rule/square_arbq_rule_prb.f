...
c*********************************************************************72
c
cc MAIN is the main program for SQUARE_ARBQ_RULE_PRB.
c
c  Discussion:
c
c    SQUARE_ARBQ_RULE_PRB tests the SQUARE_ARBQ_RULE library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 calls SQUARE_ARBQ for a quadrature rule of given order.
c
c  Licensing:
c
c    This code is distributed under the GNU GPL license.
...
c
      ...
      do i = 1, n
        ...
        call lege2eva ( degree, z, pols, work )
