...
c*********************************************************************72
c
cc C_HB is the main program for C_HB.
c
c  Licensing:
c
...
c
      call chbcode1 ( n, n, nnz, values, rowind, colptr )
      ...
      call c_bridge_pcgssv ( nprocs, n, nnz, nrhs, values, rowind, 
     &  colptr, b, ldb, info )
c
...
c
      if ( info .ne. 0 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'C_HB - Fatal error!'
        write ( *, '(a,i6)' ) '  C_BRIDGE_PCGSSV returns INFO = ', info
        stop 1
      end if
c
...
c
      ...
      subroutine chbcode1 ( nrow, ncol, nnzero, values, rowind, colptr )

c*********************************************************************72
c
cc CHBCODE1 is a sample code for reading a Harwell-Boeing sparse matrix file.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c    Output, complex VALUES(NNZERO), the nonzero matrix values.
c
