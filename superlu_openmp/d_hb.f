...
c********************************************************************72
c
cc MAIN is the main program for D_HB.
c
c  Licensing:
c
...
c
      ...
      call dhbcode1 ( n, n, nnz, values, rowind, colptr )
...
c
      if ( info .ne. 0 ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'D_HB - Fatal error!'
        write ( *, '(a,i6)' ) '  C_BRIDGE_PDGSSV returns INFO = ', info
        stop 1
      end if
c
...
c*********************************************************************72
c
cc DHBCODE1 is a sample code for reading a Harwell-Boeing sparse matrix file.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c    Output, double precision VALUES(NNZERO), the nonzero matrix values.
c
