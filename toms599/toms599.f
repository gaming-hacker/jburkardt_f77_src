...
c*********************************************************************72
c
cc SUNIF samples the standard uniform distribution on [0,1].
c
c  Modified:
c
c    22 April 2013
...
c  Author:
c
c    Joachim Ahrens, Klaus-Dieter Kohrt, Ulrich Dieter
c
c  Reference:
c
c    Joachim Ahrens, Klaus-Dieter Kohrt, Ulrich Dieter,
c    Algorithm 599:
c    Sampling from Gamma and Poisson Distributions,
...
c*********************************************************************72
c
cc KPOISSON samples the poisson distribution.
c
c  Modified:
c
c    22 April 2013
