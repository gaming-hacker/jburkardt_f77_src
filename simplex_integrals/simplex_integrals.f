...
c*****************************************************************************80
c
cc SIMPLEX01_MONOMIAL_INTEGRAL: integrals in the unit simplex in M dimensions.
c
c  Discussion:
c
...
c
      ...
      do i = 1, m
        if ( e(i) .lt. 0 ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 
     &      'SIMPLEX01_MONOMIAL_INTEGRAL - Fatal error!'
...
c*********************************************************************72
c
cc SIMPLEX01_SAMPLE samples the unit simplex in M dimensions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc SIMPLEX01_VOLUME returns the volume of the unit simplex in M dimensions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c    Input, integer M, the spatial dimension.
c
c    Output, double precision SIMPLEX01_VOLUME, the volume.
c
      implicit none
      ...
      do i = 1, m
        simplex01_volume = simplex01_volume / dble ( i )
      end do
