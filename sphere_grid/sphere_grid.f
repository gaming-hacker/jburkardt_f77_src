...
c
     ...
     &    + cos ( lat1 ) * cos ( lat2 ) * cos ( lon1 - lon2 )
      ...
      subroutine sphere_fibonacci_points ( n, xyz )

c*********************************************************************72
c
cc SPHERE_FIBONACCI_POINTS computes sphere points on a Fibonacci spiral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c    Input, integer N, the number of points.
c
c    Output, double precision XYZ(3,N), the Fibonacci spiral points.
c
      implicit none
