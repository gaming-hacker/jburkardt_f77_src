...
c*********************************************************************72
c
cc MAIN is the main program for QWV_2D_PRB.
c
c  Discussion:
c
c    QWV_2D_PRB tests the QWV_2D library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 tests QWV_2D for a trio of points.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) 'TEST01:'
      write ( *, '(a)' ) 
     &  '  Compute the weights associated with an interpolatory'
      write ( *, '(a)' ) 
     &  '  quadrature rule defined by N=(T+1)*(T+2)/2 points,'
      write ( *, '(a)' ) 
     &  '  exact for polynomials of total degree T or less.'
      write ( *, '(a)' ) ' '
...
c*********************************************************************72
c
cc TEST02 tests QWV_2D for Padua points
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
