...
c
     ...
     +          ax,ay,cu,bdlw,bdup,cflw,cfup,ru(93),su(100)
c
...
c
        ...
        s=-ax*rxx-ay*ryy+cu*r
        values(k0)=(ax*ux**2+ay*uy**2+cu*u**2)/2.0d0-s*u
        values(kx)=ax*ux
        values(ky)=ay*uy
        values(ku)=cu*u-s
        values(kxx)=ax
...
c
     ...
     6      'n i= 1,n=ax,    a=ax,t=r',
     7      'n i= 2,n=ay,    a=ay,t=r',
     8      'n i= 3,n=cu,    a=cu,t=r',
...
c
     ...
     1          w(*),x(9),y(9)
            character*80
     +          sp(100),su(100)
            save x,y,ntf,nvf,ncf,nbf,ispd,iprob,ifirst,iadapt,irefn
c
            ...
            data iprob,ifirst,iadapt,irefn/2,1,4,2/
c
c           common /atest2/ix,iy,ixl,iyl,ixu,iyu,iu(94),
c    +          ax,ay,cu,bdlw,bdup,cflw,cfup,ru(93),su(100)
c
        if(ip(41).eq.1) then
            sp(1)='obstacle'
            sp(2)='obstacle'
