...
c*********************************************************************72
c
cc MAIN is the main program for SPARSE_GRID_CC_DATASET.
c
c  Discussion:
c
c    This program computes a sparse grid quadrature rule based on a 1D
c    Clenshaw-Curtis rule and writes it to a file..
c
...
c  Licensing:
c
c    This software is released under the GNU LGPL license.
c
c  Modified:
c
c    16 March 2013
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a,i8)' ) 
     &  '  Spatial dimension requested is = ', dim_num
c
c  Get the level.
c
      if ( 2 .le. arg_num ) then
        ...
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 
     &    '  Enter the value of LEVEL_MAX (0 or greater).'
        read ( *, * ) level_max
      end if
...
c
c  How many distinct points will there be?
c
...
c
c  Allocate memory by calling a subroutine.
c
      call main_sub ( dim_num, point_num, level_max )
c
c  Terminate.
c
      write ( *, '(a)' ) ' '
      ...
      subroutine main_sub ( dim_num, point_num, level_max )

c*********************************************************************72
c
cc MAIN_SUB allocates memory for the main program.
c
c  Licensing:
c
c    This software is released under the GNU LGPL license.
...
c
      ...
      integer dim
      character * ( 3 ) dim_num_string
      integer ierror
      integer last
      integer level_max
      character * ( 2 ) level_max_string
      integer level_min
      integer point
...
c
     ...
     &  '  First 10 weights:' )
      ...
      weight_sum = r8vec_sum ( point_num, w )
