...
c*********************************************************************72
c
cc CUBE01_VOLUME: volume of the unit cube in 3D.
c
c  Licensing:
c
...
c  Parameters:
c
c    Output, double precision CUBE01_VOLUME, the volume.
c
      implicit none
...
c*********************************************************************72
c
cc CUBE01_MONOMIAL_INTEGRAL: integral over interior of unit cube in 3D.
c
c  Discussion:
c
...
c
     ...
     &     e(3) .lt. 0 ) then
      ...
      subroutine cube01_sample ( n, seed, x )

c*********************************************************************72
c
cc CUBE01_SAMPLE samples the interior of the unit cube in 3D.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
