...
!
  ...
  write ( *, '(a)' ) '  SET sets the interpolant.'
  write ( *, '(a)' ) '  VALUE evaluates it.'
  ...
  call lagrange_interp_nd_set ( m, n_1d, ab, f_sinr, nd, xd, zd )
!
!  Evaluate.
!
  write ( *, '(a)' ) ''
...
!
  ...
  write ( *, '(a)' ) '  SET2 sets the interpolant.'
  write ( *, '(a)' ) '  VALUE2 evaluates it.'
  ...
  call lagrange_interp_nd_set2 ( m, ind, ab, f_sinr, nd, xd, zd )
!
!  Evaluate.
!
  write ( *, '(a)' ) ''
...
!
  ...
  do l = 0, 10
    ...
    call lagrange_interp_nd_set ( m, n_1d, ab, f_poly352, nd, xd, zd )
!
!  Evaluate.
!
    call lagrange_interp_nd_value ( m, n_1d, ab, nd, zd, ni, xi, zi )
