...
c*********************************************************************72
c
cc MAIN is the main program for CIRCLE_INTEGRALS_PRB.
c
c  Discussion:
c
c    CIRCLE_INTEGRALS_PRB tests the CIRCLE_INTEGRALS library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 uses CIRCLE01_SAMPLE to compare exact and estimated monomial integrals.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TEST01'
      write ( *, '(a)' ) '  Use CIRCLE01_SAMPLE to compare exact '
      write ( *, '(a)' ) '  and estimated integrals along the'
      write ( *, '(a)' ) '  circumference of the unit circle in 2D.'
c
c  Get sample points.
c
      seed = 123456789
