...
c*********************************************************************72
c
cc MAIN is the main program for LINE_NCO_RULE_PRB.
c
c  Discussion:
c
c    LINE_NCO_RULE_PRB tests the LINE_NCO_RULE library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 computes and prints NCO rules.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) 'TEST01'
      write ( *, '(a)' ) 
     &  '  LINE_NCO_RULE computes the Newton-Cotes Open (NCO) rule'
      write ( *, '(a)' ) 
...
c*********************************************************************72
c
cc TEST02 uses NCO rules to estimate the integral of exp(x) from 0 to 1.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) ''
      write ( *, '(a)' ) 'TEST02'
      write ( *, '(a)' ) '  Use a sequence of NCO rules to compute an'
