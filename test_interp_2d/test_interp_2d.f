...
c
      ...
      do i = 1, n
        f(i) = 
     &      0.75D+00 * exp ( 
     &        - ( ( 9.0D+00 * x(i) - 2.0D+00 )**2            
     &          + ( 9.0D+00 * y(i) - 2.0D+00 )**2 ) / 4.0D+00 )  
     &    + 0.75D+00 * exp ( 
     &        - ( ( 9.0D+00 * x(i) + 1.0D+00 )**2 ) / 49.0D+00   
     &          - ( 9.0D+00 * y(i) + 1.0D+00 )      / 10.0D+00 )      
     &    + 0.5D+00  * exp ( 
     &        - ( ( 9.0D+00 * x(i) - 7.0D+00 )**2            
     &          + ( 9.0D+00 * y(i) - 3.0D+00 )**2 ) / 4.0D+00 )  
     &    - 0.2D+00  * exp ( 
     &          - ( 9.0D+00 * x(i) - 4.0D+00 )**2            
     &          - ( 9.0D+00 * y(i) - 7.0D+00 )**2 )
      end do
...
c
     ...
     &      - ( 9.0D+00 * y(i) - 7.0D+00 )**2 )
        ...
        fx(i) =
     &    - 3.375D+00               * ( 9.0D+00 * x(i) - 2.0 ) * t1
     &    - ( 27.0D+00 / 98.0D+00 ) * ( 9.0D+00 * x(i) + 1.0 ) * t2
     &    - 2.25D+00                * ( 9.0D+00 * x(i) - 7.0 ) * t3
     &    + 3.6D+00                 * ( 9.0D+00 * x(i) - 4.0 ) * t4

        fy(i) =
     &    - 3.375D+00 * ( 9.0D+00 * y(i) - 2.0D+00 ) * t1
     &    - 0.675D+00                                * t2
     &    - 2.25D+00  * ( 9.0D+00 * y(i) - 3.0D+00 ) * t3
     &    + 3.6D+00   * ( 9.0D+00 * y(i) - 7.0D+00 ) * t4
...
c
      ...
      do i = 1, n
        ...
        t1 = exp ( - ( ( 9.0D+00 * x(i) - 2.0D+00 )**2
     &               + ( 9.0D+00 * y(i) - 2.0D+00 )**2 ) / 4.0D+00 )
        t2 = exp ( - ( ( 9.0D+00 * x(i) + 1.0D+00 )**2 ) / 49.0D+00
     &               - ( 9.0D+00 * y(i) + 1.0D+00 ) / 10.0D+00 )
        t3 = exp ( - ( ( 9.0D+00 * x(i) - 7.0D+00 )**2
     &               + ( 9.0D+00 * y(i) - 3.0D+00 )**2 ) / 4.0D+00 )
        t4 = exp ( -   ( 9.0D+00 * x(i) - 4.0D+00 )**2
     &               - ( 9.0D+00 * y(i) - 7.0D+00 )**2 )

        fxx(i) =
     &      15.1875D+00 * ( ( 9.0D+00 * x(i) 
     &    - 2.0D+00 )**2 - 2.0D+00 )  * t1
     &    + 60.75D+00   * ( ( 9.0D+00 * x(i) 
     &    + 1.0D+00 )**2 - 24.5D+00 ) * t2
     &    + 10.125D+00  * ( ( 9.0D+00 * x(i) 
     &    - 7.0D+00 )**2 - 2.0D+00 )  * t3
     &    - 64.8D+00    * ( ( 9.0D+00 * x(i) 
     &    - 4.0D+00 )**2 - 0.5D+00 )  * t4

        fxy(i) =
     &      15.1875D+00 * ( 9.0D+00 * x(i) - 2.0D+00 ) 
     &    * ( 9.0D+00 * y(i) - 2.0D+00 ) * t1
     &    + ( 243.0D+00 / 980.0D+00 ) 
     &    * ( 9.0D+00 * x(i) + 1.0D+00 ) * t2
     &    + 10.125D+00 * ( 9.0D+00 * x(i) - 7.0D+00 ) 
     &    * ( 9.0D+00 * y(i) - 3.0D+00 ) * t3
     &    - 64.8D+00 * ( 9.0D+00 * x(i) - 4.0D+00 ) 
     &    * ( 9.0D+00 * y(i) - 7.0D+00 ) * t4

        fyy(i) =
     &      15.1875D+00 * ( ( 9.0D+00 * y(i) - 2.0D+00 )**2 
     &    - 2.0D+00 ) * t1
     &    + 0.6075D+00  * t2
     &    + 10.125D+00  * ( ( 9.0D+00 * y(i) - 3.0D+00 )**2 
     &    - 2.0D+00 ) * t3
     &    - 64.8D+00    * ( ( 9.0D+00 * y(i) - 7.0D+00 )**2 
     &    - 0.5D+00 ) * t4
...
c
      ...
      do i = 1, n 
        f(i) = ( tanh ( 9.0D+00 * ( y(i) - x(i) ) ) + 1.0D+00 ) 
     &    / 9.0D+00
      end do
...
c
      ...
      do i = 1, n
        t1 = 18.0D+00 * ( y(i) - x(i) )
        fx(i) = - 4.0D+00 / ( exp ( t1 ) + 2.0D+00 + exp ( - t1 ) )
        fy(i) = - fx(i)
      end do
...
c
      ...
      do i = 1, n
        ...
        fxx(i) = 18.0D+00 * tanh ( 0.5D+00 * t1 )
     &    * ( tanh ( 9.0D+00 * ( y(i) - x(i) ) ) + 1.0D+00 ) / 9.0D+00
        fxy(i) = - fxx(i)
        fyy(i) = fxx(i)
      end do
...
c
      ...
      do i = 1, n
        f(i) = ( 1.25D+00 + cos ( 5.4D+00 * y(i) ) )
     &    / ( 6.0D+00 + 6.0D+00 * ( 3.0D+00 * x(i) - 1.0D+00 )**2 )
      end do
...
c
      ...
      do i = 1, n
        t1 = 5.4D+00 * y(i)
        t2 = 1.0D+00 + ( 3.0D+00 * x(i) - 1.0D+00 )**2
        fx(i) = - ( 3.0D+00 * x(i) - 1.0D+00 )
     &    * ( 1.25D+00 + cos ( t1 ) ) / ( t2 * t2 )
        fy(i) = - 0.9D+00 * sin ( t1 ) / t2
      end do
...
c
      ...
      do i = 1, n 
        ...
        fxx(i) = 3.0D+00 * ( 1.25D+00 + cos ( t1 ) ) 
     &    * ( 3.0D+00 * t2 - 4.0D+00 )
     &    / ( t2**3 )
        fxy(i) = 5.4D+00 * ( 3.0D+00 * x(i) - 1.0D+00 ) * sin ( t1 )
     &    / ( t2 * t2 )
        fyy(i) = - 4.86D+00 * cos ( t1 ) / t2
      end do
...
c
      ...
      do i = 1, n
        t1 = x(i) - 0.5D+00
        t2 = y(i) - 0.5D+00
        t3 = - 3.375D+00 * exp ( - 5.0625D+00 * ( t1 * t1 + t2 * t2 ) )
        fx(i) = t1 * t3
        fy(i) = t2 * t3
      end do
...
c
      ...
      do i = 1, n
        ...
        t2 = y(i) - 0.5D+00
        t3 = - 3.375D+00
     &    * exp ( - 5.0625D+00 * ( t1 * t1 + t2 * t2 ) )

        fxx(i) = ( 1.0D+00 - 10.125D+00 * t1 * t1 ) * t3
        fxy(i) = - 10.125D+00 * t1 * t2 * t3
        fyy(i) = ( 1.0D+00 - 10.125D+00 * t2 * t2 ) * t3
      end do
...
c
      ...
      do i = 1, n
        t1 = x(i) - 0.5D+00
        t2 = y(i) - 0.5D+00
        t3 = - 13.5D+00 * exp ( - 20.25D+00 * ( t1 * t1 + t2 * t2 ) )
        fx(i) = t1 * t3
        fy(i) = t2 * t3
      end do
...
c
      ...
      do i = 1, n
        ...
        fxx(i) = ( 1.0D+00 - 40.5D+00 * t1 * t1 ) * t3
        fxy(i) = - 40.5D+00 * t1 * t2 * t3
        fyy(i) = ( 1.0D+00 - 40.5D+00 * t2 * t2 ) * t3
...
c
      ...
      do i = 1, n
        ...
        t4 = 64.0D+00 - 81.0D+00 
     &    * ( ( x(i) - 0.5D+00 )**2 + ( y(i) - 0.5D+00 )**2 )

        if ( 0.0D+00 .le. t4 ) then
          f(i) = sqrt ( t4 ) / 9.0D+00 - 0.5D+00
        else
          f(i) = 0.0D+00
        end if
...
c
     ...
     &    * ( ( x(i) - 0.5D+00 )**2 + ( y(i) - 0.5D+00 )**2 )
        ...
        if ( 0.0D+00 .lt. t4 ) then
          ...
          t2 = y(i) - 0.5D+00
          t3 = - 9.0D+00 / sqrt ( t4 )
          fxx(i) = ( 1.0D+00 + t1 * t3 * t1 * t3 ) * t3
          fxy(i) = t1 * t3 * t2 * t3
          fyy(i) = ( 1.0D+00 + t2 * t3 * t2 * t3 ) * t3
        else
          fxx(i) = 0.0D+00
          fxy(i) = 0.0D+00
          fyy(i) = 0.0D+00
...
c
      ...
      do i = 1, n
        f(i) = 2.0D+00 * cos ( 10.0D+00 * x(i) ) 
     &    * sin ( 10.0D+00 * y(i) )
     &    + sin ( 10.0D+00 * x(i) * y(i) )
      end do
...
c
      ...
      do i = 1, n
        t1 = 10.0D+00 * x(i)
        t2 = 10.0D+00 * y(i)
        t3 = 10.0D+00 * cos ( 10.0D+00 * x(i) * y(i) )
        fx(i) = - 20.0D+00 * sin ( t1 ) * sin ( t2 ) + t3 * y(i)
        fy(i) =   20.0D+00 * cos ( t1 ) * cos ( t2 ) + t3 * x(i)
      end do
...
c
      ...
      do i = 1, n
        ...
        t2 = 10.0D+00 * y(i)
        t3 = 10.0D+00 * cos ( 10.0D+00 * x(i) * y(i) )
        t4 = 100.0D+00 * sin ( 10.0D+00 * x(i) * y(i) )

        fxx(i) = - 200.0D+00 * cos ( t1 ) * sin ( t2 )
     &    - t4 * y(i) * y(i)
        fxy(i) = - 200.0D+00 * sin ( t1 ) * cos ( t2 )
     &    + t3 - t4 * x(i) * y(i)
        fyy(i) = - 200.0D+00 * cos ( t1 ) * sin ( t2 )
     &    - t4 * x(i) * x(i)
      end do
...
c
      ...
      do i = 1, n
        t1 = 5.0D+00 - 10.0D+00 * x(i)
        t2 = 5.0D+00 - 10.0D+00 * y(i)
        t3 = exp ( - 0.5D+00 * t1 * t1 )
        t4 = exp ( - 0.5D+00 * t2 * t2 )
        f(i) = t3 + 0.75D+00 * t4 * ( 1.0D+00 + t3 )
      end do
...
c
      ...
      do i = 1, n
        ...
        fx(i) = t1 * t3 * ( 10.0D+00 + 7.5D+00 * t4 )
        fy(i) = t2 * t4 * ( 7.5D+00 + 7.5D+00 * t3 )
      end do
...
c
      ...
      do i = 1, n
        ...
        fxx(i) = t3 * ( t1 * t1 - 1.0D+00 ) 
     &    * ( 100.0D+00 + 75.0D+00 * t4 )
        fxy(i) = 75.0D+00 * t1 * t2 * t3 * t4
        fyy(i) = t4 * ( t2 * t2 - 1.0D+00 ) 
     &    * ( 75.0D+00 + 75.0D+00 * t3 )
      end do
...
c
      ...
      do i = 1, n 
        t1 = exp ( ( 10.0D+00 - 20.0D+00 * x(i) ) / 3.0D+00 )
        t2 = exp ( ( 10.0D+00 - 20.0D+00 * y(i) ) / 3.0D+00 )
        t3 = 1.0D+00 / ( 1.0D+00 + t1 )
        t4 = 1.0D+00 / ( 1.0D+00 + t2 )
        f(i) = ( ( 20.0D+00 / 3.0D+00 )**3 * t1 * t2 )**2
     &    * ( t3 * t4 )**5
     &    * ( t1 - 2.0D+00 * t3 ) * ( t2 - 2.0D+00 * t4 )
      end do
...
c
      ...
      do i = 1, n
        ...
        fx(i) = ( ( 20.0D+00 / 3.0D+00 ) * t1 )**2 
     &    * ( ( 20.0D+00 / 3.0D+00 ) * t3 )**5
     &    * ( 2.0D+00 * t1 - 3.0D+00 * t3 
     &    - 5.0D+00 + 12.0D+00 * t3 * t3 )
     &    * t2 * t2 * t4**5
     &    * ( t2 - 2.0D+00 * t4 )

        fy(i) = ( ( 20.0D+00 / 3.0D+00 ) * t1 )**2 
     &    * ( ( 20.0D+00 / 3.0D+00 ) * t3 )**5
     &    * ( 2.0D+00 * t2 - 3.0D+00 * t4 
     &    - 5.0D+00 + 12.0D+00 * t4 * t4 )
     &    * t2 * t2 * t4**5
     &    * ( t1 - 2.0D+00 * t3 )
      end do
...
c
      ...
      do i = 1, n
        ...
        fxx(i) = t5 * t6 * ( t2 - 2.0D+00 * t4 )
     &    * ( ( ( - 84.0D+00 * t3 + 78.0D+00 ) * t3 + 23.0D+00 ) * t3
     &    + 4.0D+00 * t1 - 25.0D+00 )

        fxy(i) = t5 * t6
     &    * ( ( 12.0D+00 * t4 - 3.0D+00 ) * t4 
     &    + 2.0D+00 * t2 - 5.0D+00 )
     &    * ( ( 12.0D+00 * t3 - 3.0D+00 ) * t3 
     &    + 2.0D+00 * t1 - 5.0D+00 )

        fyy(i) = t5 * t6 * ( t1 - 2.0D+00 * t3 )
     &    * ( ( ( - 84.0D+00 * t4 + 78.0D+00 ) * t4 + 23.0D+00 ) * t4
     &    + 4.0D+00 * t2 - 25.0D+00 )
      end do
...
c
      ...
      do i = 1, n
        t1 = sqrt ( ( 80.0D+00 * x(i) - 40.0D+00 )**2 
     &            + ( 90.0D+00 * y(i) - 45.0D+00 )**2 )
        t2 = exp ( - 0.04D+00 * t1 )
        t3 = cos ( 0.15D+00 * t1 )
...
c
     ...
     &            + ( 90.0D+00 * y(i) - 45.0D+00 )**2 )
        ...
        if ( t1 .eq. 0.0D+00 ) then
          ...
          t3 = cos ( 0.15D+00 * t1 )
          t4 = sin ( 0.15D+00 * t1 )
          fx(i) = - t2 * ( 12.0D+00 * t4 + 3.2D+00 * t3 ) 
     &      * ( 80.0D+00 * x(i) - 40.0D+00 ) / t1
          fy(i) = - t2 * ( 13.5D+00 * t4 + 3.6D+00 * t3 ) 
     &      * ( 90.0D+00 * y(i) - 45.0D+00 ) / t1
        end if
...
c
     ...
     &            + ( 90.0D+00 * y(i) - 45.0D+00 )**2 )
        ...
        if ( t1 .eq. 0.0D+00 ) then
          ...
          fxx(i) = t5 * ( t1 * ( 76.8D+00 * t4 - 133.76D+00 * t3 )
     &      * ( 80.0D+00 * x(i) - 40.0D+00 )**2
     &      - ( 960.0D+00 * t4 + 256.0D+00 * t3 ) 
     &      * ( 90.0D+00 * y(i) - 45.0D+00 )**2 )

          fxy(i) = t5 * ( t1 * ( 86.4D+00 * t4 - 150.48D+00 * t3 ) 
     &      + 1080.0D+00 * t4 + 288.0D+00 * t3 ) 
     &      * ( 80.0D+00 * x(i) - 40.0D+00 ) 
     &      * ( 90.0D+00 * y(i) - 45.0D+00 )

          fyy(i) = t5 * ( t1 * ( 97.2D+00 * t4 - 169.29D+00 * t3 )
     &      * ( 90.0D+00 * y(i) - 45.0D+00 )**2 
     &      - ( 1215.0D+00 * t4 + 324.0D+00 * t3 ) 
     &      * ( 80.0D+00 * x(i) - 40.0D+00 )**2 )
