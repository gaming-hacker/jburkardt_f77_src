...
c*********************************************************************72
c
cc FD1D_ADVECTION_FTCS solves the advection equation using the FTCS method.
c
c  Discussion:
c
c    The FTCS method is unstable for the advection problem.
c
c    Given a smooth initial condition, successive FTCS approximations will
c    exhibit erroneous oscillations of increasing magnitude.
c
c  Licensing:
c
