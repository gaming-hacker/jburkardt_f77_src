...
c*********************************************************************72
c
cc MAIN is the main program for LAPACK_EXAMPLES_OSX_PRB.
c
c  Discussion:
c
c    LAPACK_EXAMPLES_OSX_PRB tests the MAC OSX LAPACK library.
c
c  Licensing:
c
...
c
      ...
      write ( *, '(a)' ) '  Test the Mac OSX LAPACK library.'
