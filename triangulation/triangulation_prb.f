...
c  Discussion:
c
c    TRIANGULATION_PRB tests the TRIANGULATION library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST127 tests TRIANGULATION_ORDER3_ADJACENCY.
c
c  Discussion:
c
...
c
     ...
     &  40, 48, 47 /
      ...
      write ( *, '(a)' ) 'TEST127'
      write ( *, '(a)' ) '  For an order3 triangulation:'
      write ( *, '(a)' ) '  TRIANGULATION_ORDER3_ADJACENCY sets the '
      write ( *, '(a)' ) '  full adjacency matrix.'

      call triangulation_order3_adjacency ( node_num, element_num, 
     &  element_node, adj )
