...
c    The convention for node indexing might start at 0 or at 1.
c
c    If this function detects 1-based indexing, it converts to 0-based.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TRIANGULATION_AREA computes the area of a triangulation.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c    Output, double precision TRIANGULATION_AREA, the area.
c
      implicit none
      ...
      integer element
      double precision element_area
      integer element_node(element_order,element_num)
      double precision element_xy(2,3)
      integer i
      integer j
      double precision node_xy(2,node_num)
      double precision triangulation_area
      double precision value
      ...
      do element = 1, element_num
        ...
        do j = 1, 3
          do i = 1, 2
            element_xy(i,j) = node_xy(i,element_node(j,element))
          end do
        end do
      ...
      subroutine triangulation_areas ( node_num, node_xy, 
     &  element_order, element_num, element_node, triangle_area,
     &  triangulation_area )

c*********************************************************************72
c
cc TRIANGULATION_AREAS computes triangle and triangulation areas.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c    Input, double precision NODE_XY(2,NODE_NUM), the coordinates of the nodes.
c
c    Input, integer ELEMENT_ORDER, the order of triangles in
c    the triangulation.
c
...
c    the nodes making up each triangle.
c
c    Output, double precision TRIANGLE_AREA(ELEMENT_NUM), the area of
c    the triangles.
c
c    Output, double precision TRIANGULATION_AREA, the area of
c    the triangulation.
c
      implicit none
      ...
      double precision node_xy(2,node_num)
      integer triangle
      double precision triangle_area(element_num)
      integer element_node(element_order,element_num)
      integer i
      integer j
      ...
      do triangle = 1, element_num
        ...
        do j = 1, 3
          do i = 1, 2
            triangle_xy(i,j) = node_xy(i,element_node(j,triangle))
          end do
        end do

        call triangle_area_2d ( triangle_xy, triangle_area(triangle) )

        triangulation_area = triangulation_area 
...
c*********************************************************************72
c
cc TRIANGULATION_ORDER3_ADJACENCY computes the full adjacency matrix
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c    the nodes making up each triangle.
c
c    Output, integer ADJ(NODE_NUM,NODE_NUM), the adjacency
c    matrix.  ADJ(I,J) is 1 if nodes I and J are adjacent, that is,
c    they are immediate neighbors on an edge of the triangulation.
c
      implicit none
