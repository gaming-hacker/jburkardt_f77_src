...
c*********************************************************************72
c
cc MAIN is the main program for FEM1D_BVP_LINEAR_PRB.
c
c  Location:
c
c    http://people.sc.fsu.edu/~jburkardt/f77_src/fem1d_bvp_linear/fem1d_bvp_linear_prb.f
c
c  Discussion:
c
c    FEM1D_BVP_LINEAR_PRB tests the FEM1D_BVP_LINEAR library.
c
c  Licensing:
c
...
c
        ...
        call h1s_error_linear ( n, x, u, exact_ux6, 
     &    h1s )
...
c
        ...
        call h1s_error_linear ( n, x, u, exact_ux7, 
     &    h1s )
