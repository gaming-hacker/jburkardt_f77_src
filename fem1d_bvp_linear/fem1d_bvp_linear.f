...
c  Location:
c
c    http://people.sc.fsu.edu/~jburkardt/f77_src/fem1d_bvp_linear/fem1d_bvp_linear.f
c
c  Discussion:
c
...
c
c    Output, double precision U(N), the finite element coefficients, which are 
c    also the value of the computed solution at the mesh points.
c
      implicit none
...
c*********************************************************************72
c
cc H1S_ERROR_LINEAR estimates the seminorm error of a finite element solution.
c
c  Discussion:
c
...
c*********************************************************************72
c
cc L2_ERROR_LINEAR estimates the L2 error norm of a finite element solution.
c
c  Discussion:
c
c    We assume the finite element method has been used, over an interval [A,B]
