c ********************************************************************
c     This is the file curvih.for which uses function, gradient and
c     hessian values.
c  ********************************************************************
c ---------------------------------------------------------------------
...
c
c    hessia:  user supplied subroutine which computes the Hessian of
c             the function to be minimized.
c
c     Usage:  call hessia(n,x,h)
c         h:  vector of dimension  n*(n+1)/2 containing the upper 
...
c
c     itrid:  set this parameter to 1 if the Hessian is tridiagonal.
c
...
c
c      nhes:  number of Hessian evaluations.
c
...
c----------------------------------------------------------------------
c               Latest revision: Hugo D.Scolnik June 6, 2017
c----------------------------------------------------------------------
