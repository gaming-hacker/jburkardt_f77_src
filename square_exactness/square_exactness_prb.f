...
c*********************************************************************72
c
cc MAIN is the main program for SQUARE_EXACTNESS_PRB.
c
c  Discussion:
c
c    SQUARE_EXACTNESS_PRB tests the SQUARE_EXACTNESS library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 tests product Gauss-Legendre rules for the Legendre 2D integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST02 tests Padua rules for the Legendre 2D integral.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc LEGENDRE_2D_SET: set a 2D Gauss-Legendre quadrature rule.
c
c  Discussion:
c
c    The integral:
c
c      integral ( a(2) <= y <= b(2) ) ( a(1) <= x <= b(1) ) f(x,y) dx dy
c
c    The quadrature rule:
c
c      sum ( 1 <= i <= n ) w(i) * f ( x(i),y(i) )
c
c    where n = nx * ny, the orders of the rule in the X and Y directions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c  Parameters:
c
c    Input, double precision A(2), B(2), the lower and upper integration
c    limits.
c
c    Input, integer NX, NY, the orders in the X and Y directions.
c    NX and NY must be between 1 and 10.
c
c    Output, double precision X(N), Y(N), the abscissas.
c
...
c
      ...
      double precision x(nx*ny)
      double precision xx(nx)
      double precision y(nx*ny)
...
c*********************************************************************72
c
cc PADUA_POINT_SET sets the Padua points.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc PADUA_WEIGHT_SET sets quadrature weights for the Padua points.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
