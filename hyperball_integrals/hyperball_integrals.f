...
c*********************************************************************72
c
cc HYPERBALL01_MONOMIAL_INTEGRAL: integrals in unit hyperball in M dimensions.
c
c  Discussion:
c
...
c
c    Input, integer E(M), the exponents.  Each exponent must be nonnegative.
c
...
c
      ...
      do i = 1, m
        if ( e(i) < 0 ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 
     &      'HYPERBALL01_MONOMIAL_INTEGRAL - Fatal error!'
...
c
      ...
      subroutine hyperball01_sample ( m, n, seed, x )

c*********************************************************************72
c
cc HYPERBALL01_SAMPLE samples points from the unit hyperball in M dimensions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc HYPERBALL01_VOLUME returns the volume of the unit hyperball in M dimensions.
c
c  Discussion:
c
c     M  Volume
...
c    Input, integer M, the spatial dimension.
c
c    Output, double precision HYPERBALL01_VOLUME, the volume.
c
      implicit none
