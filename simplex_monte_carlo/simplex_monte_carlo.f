...
c*****************************************************************************80
c
cc SIMPLEX_UNIT_MONOMIAL_INTEGRAL: integrals in the unit simplex in M dimensions.
c
c  Discussion:
c
...
c
      ...
      do i = 1, m
        if ( e(i) .lt. 0 ) then
          write ( *, '(a)' ) ' '
          write ( *, '(a)' ) 
     &      'SIMPLEX_UNIT_MONOMIAL_INTEGRAL - Fatal error!'
...
c*********************************************************************72
c
cc SIMPLEX_UNIT_SAMPLE samples the unit simplex in M dimensions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc SIMPLEX_UNIT_VOLUME returns the volume of the unit simplex in M dimensions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c    Input, integer M, the spatial dimension.
c
c    Output, double precision SIMPLEX_UNIT_VOLUME, the volume.
c
      implicit none
      ...
      simplex_unit_volume = 1.0D+00
      do i = 1, m
        simplex_unit_volume = simplex_unit_volume / dble ( i )
      end do
