...
c*********************************************************************72
c
cc HYPERBALL01_MONOMIAL_INTEGRAL: monomial integrals in unit hyperball.
c
c  Discussion:
c
...
c*********************************************************************72
c
cc HYPERBALL01_SAMPLE uniformly samples points from the unit hyperball.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc HYPERBALL01_VOLUME returns the volume of the unit hyperball.
c
c  Discussion:
c
c     M  Volume
