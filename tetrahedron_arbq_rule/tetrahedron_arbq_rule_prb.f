...
c*********************************************************************72
c
cc MAIN is the main program for TETRAHEDRON_ARBQ_RULE_PRB.
c
c  Discussion:
c
c    TETRAHEDRON_ARBQ_RULE_PRB tests the TETRAHEDRON_ARBQ_RULE library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 calls TETRAHEDRON_ARBQ for a quadrature rule of given order.
c
c  Licensing:
c
c    This code is distributed under the GNU GPL license.
