...
c    a natural death rate; instead, they only die by being eaten by the 
c    predator.  Every prey animal has 1 chance in 1000 of being eaten in a 
c    given year by a given predator.
c
