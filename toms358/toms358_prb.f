...
c*********************************************************************72
c
cc MAIN is the main program for TOMS358_PRB.
c
c  Discussion:
c
c    TOMS358_PRB tests the TOMS358 library.
c
...
c
c  N = 2
c  (A case which was misbehaving recently.)
c
      m = 5
      n = 2
...
c
      ...
      call test02 ( m, n, a, e, s2, u, v, work )
c
c  CSVD cannot handle the following case, where M < N, 
c  but CSVDC can handle it.
c
      m = 3
      n = 5
