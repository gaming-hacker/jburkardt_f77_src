...
c*********************************************************************72
c
cc SURFACE_GRID uses DISLIN to display Z(X,Y) data as a surface.
c
c  Discussion:
c
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'SURFACE_GRID:'
      write ( *, '(a)' ) '  FORTRAN77 version'
      write ( *, '(a)' ) 
     &  '  Use DISLIN to plot Z(X,Y) data as a surface.'
c
c  Read the data.
c
      m = 3
      call r4mat_data_read ( 'surface_grid.txt', m, n * n, xyz )
c
c  Split the data.
c
      k = 0
...
c
      call simplx ( )
c
c  Set the axis origin 80 plot units to the right, and 2500 plot units DOWN.
c
      call axspos ( 80, 2500 )
c
