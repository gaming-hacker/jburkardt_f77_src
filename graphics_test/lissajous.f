...
c*********************************************************************72
c
cc LISSAJOUS uses DISLIN to draw a plot of a Lissajous planar curve.
c
c  Discussion:
c
...
c
      ...
      write ( *, '(a)' ) 
     &  '  Use DISLIN routines to plot (X,Y) data as a plane curve.'
c
c  Read the data.
c
      call r4mat_data_read ( 'lissajous.txt', m, n, xy )
c
...
c
      call simplx ( )
c
c  Set the axis origin plot units to the right, and plot units DOWN.
c
