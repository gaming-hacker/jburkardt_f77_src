...
c*********************************************************************72
c
cc MAIN is the main program for MACHINE_PRB.
c
c  Discussion:
c
c    MACHINE_PRB tests the MACHINE library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc I1MACH_PRB reports the constants returned by I1MACH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc R1MACH_PRB reports the constants returned by R1MACH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'R1MACH_TEST'
      write ( *, '(a)' ) '  R1MACH returns constants associated with'
      write ( *, '(a)' ) '  real single precision computer arithmetic.'

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) '  Assume that single precision numbers are'
      write ( *, '(a)' ) 
     &  '  stored with a mantissa of T digits in base B,'
      write ( *, '(a)' ) '  with an exponent whose value is between '
      write ( *, '(a)' ) '  EMIN and EMAX.'
