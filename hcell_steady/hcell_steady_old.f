...
c
c    integer MINUN is an estimate of the necessary bandwidth 
...
c
      alpha = 1.0D+00
c
c  JVB: Try manipulating ALPHA rather than RE.
c
      alpha = 0.25D+00
...
c*********************************************************************72
c
cc D_HUGE returns a "huge" double precision number.
c
c  Modified:
c
c    13 April 2004
...
c  Parameters:
c
c    Output, double precision D_HUGE, a huge number.
c
      implicit none
