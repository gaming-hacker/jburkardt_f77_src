...
c*********************************************************************72
c
cc MAIN is the main program for TRIANGLE_TO_FEM.
c
c  Discussion:
c
c    TRIANGLE_TO_FEM converts mesh data from TRIANGLE format to FEM format.
c
c  Usage:
c
c    triangle_to_fem prefix
c
...
c
      call triangle_node_size_read ( triangle_node_filename, 
     &  node_num, m, node_att_num, node_marker_num )
...
c
     ...
     &  triangle_element_filename, fem_node_filename, 
     &  fem_element_filename, element_att_num, element_num, 
