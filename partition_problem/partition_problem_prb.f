...
c*********************************************************************72
c
cc MAIN is the main program for PARTITION_PROBLEM_PRB.
c
c  Discussion:
c
c    PARTITION_PROBLEM_PRB tests the PARTITION_PROBLEM library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 tests PARTITION_BRUTE.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c    Input, integer W(N), a set of weights.
c
      implicit none
...
c*********************************************************************72
c
cc TEST02 tests PARTITION_COUNT.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
