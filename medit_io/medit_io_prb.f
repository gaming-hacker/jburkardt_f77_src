...
c*********************************************************************72
c
cc MAIN is the main program for MEDIT_IO_PRB.
c
c  Discussion:
c
c    MEDIT_IO_PRB tests the MEDIT_IO library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc MEDIT_IO_TEST03 reads and prints the sizes in a MESH dataset.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc MEDIT_IO_TEST04 reads a MESH dataset and prints its data.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
