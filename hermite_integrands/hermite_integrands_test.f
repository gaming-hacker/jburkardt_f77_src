...
c*********************************************************************72
c
cc MAIN is the main program for hermite_integrands_test.
c
c  Discussion:
c
c    hermite_integrands_test tests the hermite_integrands library.
c
c  Licensing:
c
...
c
      ...
      call timestamp ( )
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'hermite_integrands_test'
      write ( *, '(a)' ) '  FORTRAN77 version'
      write ( *, '(a)' ) '  Test the hermite_integrands library.'
