...
c    from T.
c
c    Input/output, real Y(N), the values of the dependent variables.
c
...
c
      ...
      if(h.gt.0.0e+00.and.t.ge.tout)then
        return
      end if

      if(h.lt.0.0e+00.and.t.le.tout) then
        return
      end if
...
c
c    y(n)      initial value of the dependent variables.
c
c    dy(n)     initial value of the derivatives.
c
c    dy1(n)    work space
c
c    h      step size.
c
c    y1(n)     the value of y at t+h as computed by this program.
c
c    y2(n)     work space
c
c    y3(n)     work space
...
c
c    Input, real T, the current value of the independent variable.
c
