...
c  Discussion:
c
c    C8LIB_PRB tests the C8LIB library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc C8_ACOSH_TEST tests C8_ACOSH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_ASINH_TEST tests C8_ASINH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_ATANH_TEST tests C8_ATANH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
     ...
     &  '---------------------  --------------------'
      ...
      do test = 1, test_num
        ...
        write ( *, '(2x,2f12.4,2x,2f12.4,2x,2f12.4,2x,2f12.4)' )
     &    c1, c2, c3
...
c*********************************************************************72
c
cc C8_CUBE_ROOT_TEST tests C8_CUBE_ROOT.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) 
     &  '        C1=C8_UNIFORM_01       ' // 
     &  '   C2=C8_UNIFORM_01          C3=C8_DIV(C1,C2)' //
     &  '           C4=C1/C2'
      write ( *, '(a)' ) 
     &  '     ---------------------     ' // 
     &  '---------------------' //
...
c*********************************************************************72
c
cc C8_DIV_R8_TEST tests C8_DIV_R8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) 
     &  '        C1=C8_UNIFORM_01       ' // 
     &  '   R2=R8_UNIFORM_01          C3=C8_DIV_R8(C1,R2)' //
     &  '           C4=C1/R2'
      write ( *, '(a)' ) 
     &  '     ---------------------     ' // 
     &  '---------------------' //
     ...
     &  '    ---------------------'
      ...
      do test = 1, test_num
        ...
        write ( *, '(2x,2f12.4,2x,f12.4,12x,2x,2f12.4,2x,2f12.4)' ) 
     &    c1, r2, c3, c4
...
c*********************************************************************72
c
cc C8_LE_L1_TEST tests C8_LE_L1.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
     ...
     &  '  C8_LE_L1 evalues (C1 <= C2) using the L1 norm.'
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 
     &  '        C1=C8_UNIFORM_01          C2=C8_UNIFORM_01   ' //
     &  '      L3=C8_LE_L1(C1,C2)'
      write ( *, '(a)' ) 
     &   '     ---------------------     ---------------------' //
     &  '     ---------------------'
...
c*********************************************************************72
c
cc C8_LE_L2_TEST tests C8_LE_L2.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_LE_LI_TEST tests C8_LE_LI.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_NORM_L1_TEST tests C8_NORM_L1.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_NORM_L2_TEST tests C8_NORM_L2.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_NORM_LI_TEST tests C8_NORM_LI.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_PRINT_TEST tests C8_PRINT.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      c1 = dcmplx (  0.0D+00,               0.0D+00 )
      c2 = dcmplx (  1.0D+00,               0.0D+00 )
      c3 = dcmplx (  3.141592653589793D+00, 0.0D+00 )
      c4 = dcmplx (  0.0D+00,               1.0D+00 )
      c5 = dcmplx (  1.0D+00,               2.0D+00 )
      c6 = dcmplx ( -12.34D+00,            56.78D+00 )
      c7 = dcmplx (  0.001D+00,             0.000002D+00 )
      c8 = dcmplx (  3.0D+08,              -4.5D+09 )
...
c*********************************************************************72
c
cc C8_TO_CARTESIAN_TEST tests C8_TO_CARTESIAN.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8_TO_POLAR_TEST tests C8_TO_POLAR and POLAR_TO_C8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8MAT_IDENTITY_TEST tests C8MAT_IDENTITY.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8MAT_INDICATOR_TEST tests C8MAT_INDICATOR.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8MAT_NORM_FRO_TEST tests C8MAT_NORM_FRO.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8MAT_NORM_L1_TEST tests C8MAT_NORM_L1.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8MAT_NORM_LI_TEST tests C8MAT_NORM_LI.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_INDICATOR_TEST tests C8VEC_INDICATOR;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_NINT_TEST tests C8VEC_NINT.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_NORM_L1_TEST tests C8VEC_NORM_L1.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_NORM_L2_TEST tests C8VEC_NORM_L2.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_NORM_LI_TEST tests C8VEC_NORM_LI.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_PRINT_TEST tests C8VEC_PRINT.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_SORT_A_L1_TEST tests C8VEC_SORT_A_L1.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
     ...
     & '  I             A(I)                   L1(A(I))'
      write ( *, '(a)' ) ''
      do i = 1, n
        write ( *, '(2x,i2,2x,2g14.6,2x,g14.6)' ) 
     &  i, a(i), c8_norm_l1 ( a(i) )
      end do
...
c*********************************************************************72
c
cc C8VEC_SORT_A_L2_TEST tests C8VEC_SORT_A_L2.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_SORT_A_LI_TEST tests C8VEC_SORT_A_LI.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_SPIRAL_TEST tests C8VEC_SPIRAL;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc C8VEC_UNITY_TEST tests C8VEC_UNITY;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc CARTESIAN_TO_C8_TEST tests CARTESIAN_TO_C8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 
     &  '      X1,Y1=R8_UNIFORM_01    C2=CARTESIAN_TO_C8(X1,Y1)' //
     ...
     &  '     ---------------------'
      ...
      do test = 1, test_num
        ...
        write ( *, '(2x,2f12.4,2x,2f12.4,2x,2f12.4)' ) 
     &    x1, y1, c2, x3, y3
...
c*********************************************************************72
c
cc POLAR_TO_C8_TEST tests POLAR_TO_C8.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 
     &  '      (R1,T1)=R8_UNIFORM_01()    C2=POLAR_TO_C8(R1,T1)' //
