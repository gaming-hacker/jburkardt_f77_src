...
c*********************************************************************72
c
cc DISK_GRID computes grid points inside a disk.
c
c  Discussion:
c
c    The grid is defined by specifying the radius and center of the circle,
...
c
c    Input, double precision C(2), the coordinates of the center of the circle.
c
c    Input, integer NG, the number of grid points, as determined by
c    DISK_GRID_COUNT.
c
c    Output, double precision CG(2,NG), the grid points inside the circle.
c
      implicit none
...
10      continue
          ...
          if ( r * r .lt. ( x - c(1) )**2 + ( y - c(2) )**2 ) then
            go to 20
          end if
...
c*********************************************************************72
c
cc DISK_GRID_COUNT counts the grid points inside a disk.
c
c  Discussion:
c
c    The grid is defined by specifying the radius and center of the circle,
...
c*********************************************************************72
c
cc DISK_GRID_FIBONACCI computes Fibonacci grid points inside a disk.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c    Input, double precision C(2), the coordinates of the center of the circle.
c
c    Output, double precision G(2,N), the grid points.
c
      implicit none
