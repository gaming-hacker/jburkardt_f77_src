...
c  Discussion:
c
c    CHRPAK_PRB tests the CHRPAK library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST1227 tests S_SCRABBLE_POINTS.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TEST1227'
      write ( *, '(a)' ) '  S_SCRABBLE_POINTS returns the value of a'
      write ( *, '(a)' ) '  string as a Scrabble word.'
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) '   I  ----S-------   Value'
      write ( *, '(a)' ) ' '
      do i = 1, 12
