...
c*********************************************************************72
c
cc L4VEC_DATA_READ reads data from an L4VEC file.
c
c  Discussion:
c
c    An L4VEC is a vector of L4's.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc L4VEC_HEADER_READ reads the header from an L4VEC file.
c
c  Discussion:
c
c    An L4VEC is a vector of L4's.
...
c*********************************************************************72
c
cc L4VEC_WRITE writes an L4VEC file.
c
c  Discussion:
c
c    An L4VEC is a vector of L4's.
...
c*********************************************************************72
c
cc S_TO_L4 reads an L4 from a string.
c
c  Discussion:
c
