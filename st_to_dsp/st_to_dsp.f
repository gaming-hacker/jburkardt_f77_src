...
c*********************************************************************72
c
cc MAIN is the main program for ST_TO_DSP.
c
c  Discussion:
c
c    ST_TO_DSP converts an ST sparse matrix file to DSP format.
c
c    Each line of the ST file has the form I, J, A(I,J).
c    The DSP file uses the same format, but DSP files use 1-based
c    indexing rather than 0-based indexing.
c
c  Licensing:
c
...
c
      ...
      write ( *, '(a)' ) 
     &  '  write the corresponding DSP sparse matrix file.'
c
...
c
      ...
      call filename_ext_swap ( output_filename, 'dsp' )
c
