...
c*********************************************************************72
c
cc L4_UNIFORM returns a pseudorandom L4.
c
c  Discussion:
c
...
c    NOT be 0.  On output, SEED has been updated.
c
c    Output, logical L4_UNIFORM, a pseudorandom logical value.
c
      implicit none
      ...
      l4_uniform = ( i4_huge_half .lt. seed )
...
c*********************************************************************72
c
cc L4MAT_PRINT prints an L4MAT.
c
c  Discussion:
c
c    An L4MAT is an array of L4 values.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc L4MAT_PRINT_SOME prints some of an L4MAT.
c
c  Discussion:
c
c    An L4MAT is an array of L4 values.
...
c
      ...
      subroutine l4mat_uniform ( m, n, seed, l4mat )

c*********************************************************************72
c
cc L4MAT_UNIFORM returns a pseudorandom L4MAT.
c
c  Discussion:
c
c    An L4MAT is a two dimensional array of LOGICAL values.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    NOT be 0.  On output, SEED has been updated.
c
c    Output, logical L4MAT(M,N), a pseudorandom logical matrix.
c
      implicit none
      ...
      do j = 1, n
        ...
        do i = 1, m
          ...
          l4mat(i,j) = ( i4_huge_half .lt. seed )
...
c*********************************************************************72
c
cc L4VEC_PRINT prints an L4VEC.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c
      ...
      subroutine l4vec_uniform ( n, seed, l4vec )

c*********************************************************************72
c
cc L4VEC_UNIFORM returns a pseudorandom L4VEC.
c
c  Discussion:
c
c    An L4VEC is a vector of LOGICAL values.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c    NOT be 0.  On output, SEED has been updated.
c
c    Output, logical L4VEC(N), a pseudorandom logical vector.
c
      implicit none
...
c*********************************************************************72
c
cc R8COL_UNIFORM_ABVEC fills an R8COL with scaled pseudorandom numbers.
c
c  Discussion:
c
...
c*********************************************************************72
c
cc R8ROW_UNIFORM_ABVEC fills an R8ROW with scaled pseudorandom numbers.
c
c  Discussion:
c
