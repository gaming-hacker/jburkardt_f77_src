...
c*********************************************************************72
c
cc FD1D_ADVECTION_LAX solves the advection equation using the Lax method.
c
c  Discussion:
c
c    The Lax method is stable for the advection problem, if the time step
c    satisifies the Courant-Friedrichs-Levy (CFL) condition:
c
c      dt <= dx / c
c
c  Licensing:
