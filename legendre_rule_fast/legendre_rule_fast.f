...
c*********************************************************************72
c
cc TS_MULT evaluates a polynomial.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c  Parameters:
c
c    Input, double precision U(N+1), the polynomial coefficients.
c    U(1) is ignored.
c
c    Input, double precision H, the polynomial argument.
c
c    Input, integer N, the number of terms to compute.
c
c    Output, double precision TS_MULT, the value of the polynomial.
c
      implicit none
