...
c*********************************************************************72
c
cc MAIN is the main program for LEGENDRE_RULE.
c
c  Discussion:
c
...
c
      call legendre_handle ( order, a, b, filename )
c
c  Terminate.
c
      write ( *, '(a)' ) ' '
...
c
      ...
      subroutine legendre_handle ( order, a, b, filename )

c*********************************************************************72
c
cc LEGENDRE_COMPUTE computes a Legendre quadrature rule.
c
c  Discussion:
c
