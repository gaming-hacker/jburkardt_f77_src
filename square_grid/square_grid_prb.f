...
c*********************************************************************72
c
cc MAIN is the main program for SQUARE_GRID_PRB.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 tests SQUARE_GRID using the same parameters for all dimensions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      data a / -1.0D+00, -1.0D+00 /
      data b / +1.0D+00, +1.0D+00 /
      data c / 1, 1 /
      data ns / 3, 3 /
...
c*********************************************************************72
c
cc TEST03 uses a square with different sizes in each dimension.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      data a /  0.0D+00,  -2.0D+00 /
      data b / 10.0D+00,  +2.0D+00 /
      data c / 3, 4 /
      data ns / 3, 3 /
