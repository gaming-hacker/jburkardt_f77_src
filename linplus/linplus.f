...
c*********************************************************************72
c
cc R8BTO_MV multiplies an R8BTO matrix by an R8VEC.
c
c  Discussion:
c
c    The R8BTO storage format is for a block Toeplitz matrix. The matrix
...
c
              do i = 1, m
                do ii = 1, m
                  r5(ii,j) = r5(ii,j) + c1(i,j,i2) * a(ii,i,i1+l)
                  r6(ii,j) = r6(ii,j) + c2(i,j,i1) * a(ii,i,i1+1)
                end do
                i3 = i3 + m
              end do
            end do
...
c
        ...
        do i1 = 1, n - 1
          ...
          do i = 1, m
            do ii = 1, m
              x(ii,n) = x(ii,n) - x(i,i2) * a(ii,i,i1+l)
            end do
            i3 = i3 + m
          end do
        end do
