...
#
gfortran -fopenmp mandelbrot_open_mp.f
#
mv a.out mandelbrot
#
...
./mandelbrot > mandelbrot_ithaca_gfortran_output.txt
#
...
rm mandelbrot
#
echo "Program output written to mandelbrot_ithaca_gfortran_output.txt."
