...
c*********************************************************************72
c
cc MAIN is the main program for HYPERBALL_VOLUME_MONTE_CARLO.
c
c  Discussion:
c
...
c
      ...
      call timestamp ( )
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'HYPERBALL_VOLUME_MONTE_CARLO:'
      write ( *, '(a)' ) '  FORTRAN77 version'
      write ( *, '(a)' ) 
     &  '  Use a Monte Carlo approach to estimate the volume of'
      write ( *, '(a)' ) '  the unit hyperball in M dimensions.'
c
...
c
      ...
      if ( dim_max < dim_num ) then
        write ( *, '(a)' ) ' '
        write ( *, '(a)' ) 'HYPERBALL_VOLUME_MONTE_CARLO - Fatal error!'
...
10      continue
        ...
        if ( n_done .lt. n_more ) then
          ...
          call hyperball01_indicator ( dim_num, n2, x, fx )
...
c*********************************************************************72
c
cc HYPERBALL01_INDICATOR evaluates the unit hyperball indicator function.
c
c  Discussion:
c
c    F(X) = 1 if X is inside the unit hyperball, and 0 elsewhere.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c    Output, double precision FX(POINT_NUM), the indicator value.
c
      implicit none
...
c*********************************************************************72
c
cc HYPERBALL01_VOLUME computes the volume of the unit hyperball.
c
c  Discussion:
c
c    DIM_NUM  Volume
