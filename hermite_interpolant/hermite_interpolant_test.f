...
c*********************************************************************72
c
cc MAIN is the main program for hermite_interpolant.
c
c  Discussion:
c
c    hermite_interpolant_test tests hermite_interpolant.
c
c  Licensing:
c
...
c
      ...
      call timestamp ( )
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'hermite_interpolant_test'
      write ( *, '(a)' ) '  FORTRAN77 version'
      write ( *, '(a)' ) '  Test hermite_interpolant.'
