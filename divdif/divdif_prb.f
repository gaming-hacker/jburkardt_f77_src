...
c  Discussion:
c
c    DIVDIF_PRB tests the DIVDIF library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST11 tests LAGRANGE_RULE and LAGRANGE_SUM.
c
c  Discussion:
c
c    This test demonstrates how a divided difference table can be generated,
...
c*********************************************************************72
c
cc TEST13 tests LAGRANGE_RULE and LAGRANGE_SUM.
c
c  Discussion:
c
c    This test demonstrates how a divided difference table can be generated,
...
c*********************************************************************72
c
cc TEST15 tests LAGRANGE_RULE and LAGRANGE_SUM.
c
c  Discussion:
c
c    This test demonstrates how a divided difference table can be generated,
...
c*********************************************************************72
c
cc TEST18 tests ROOTS_TO_DIF and DIF_TO_R8POLY.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST19 tests ROOTS_TO_R8POLY.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST20 tests DIF_DERIVK_TABLE;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      double precision c0(5)
      double precision d0(5)
      double precision d1(4)
      double precision d2(3)
      double precision d3(2)
      double precision d4(1)
      double precision f0(5)
      integer i
      integer j
      integer k
      integer n0
      ...
      integer n4
      double precision x
      double precision x0(5)
      double precision x1(4)
      double precision x2(3)
      double precision x3(2)
      double precision x4(1)
      double precision y0
      double precision y1
      double precision y2
      double precision y3
...
c
c  Set data for x^4/24+x^3/3+x^2/2+x+1
c
      do j = 1, n0
        f0(j) = 1.0D+00
        do i = 4, 1, -1
          f0(j) = f0(j) * x0(j) / dble ( i ) + 1.0D+00
        end do
      end do
c
c  Compute the difference table.
c
...
c
c  Compute the difference table for the K=1 derivative.
c
      k = 1
      n1 = n0 - k
      call dif_derivk_table ( n0, x0, d0, k, x1, d1 )
c
c  Compute the difference table for the K=2 derivative.
c
      k = 2
      n2 = n0 - k
      call dif_derivk_table ( n0, x0, d0, k, x2, d2 )
c
c  Compute the difference table for the K=3 derivative.
c
      k = 3
      n3 = n0 - k
      call dif_derivk_table ( n0, x0, d0, k, x3, d3 )
c
c  Compute the difference table for the K=4 derivative.
c
      k = 4
      n4 = n0 - k
      call dif_derivk_table ( n0, x0, d0, k, x4, d4 )
c
c  Evaluate all 5 polynomials.
c
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 
...
c*********************************************************************72
c
cc TEST21tests DIF_BASIS_DERIV;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      data xd / -2.0D+00, 1.0D+00, 5.0D+00 /
...
c
c  Because the difference tables were shifted to all 0 abscissas,
c  they contain the polynomial coefficients.
c
...
c*********************************************************************72
c
cc TEST22 tests DIF_BASIS_DERIVK;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      data xd / 1.0D+00, 2.0D+00, 3.0D+00, 4.0D+00, 5.0D+00 /

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TEST22'
      write ( *, '(a)' ) '  DIF_BASIS_DERIVK computes difference tables'
      write ( *, '(a)' ) 
     &  '  for the K-th derivative of each Lagrange basis.'
