...
c*********************************************************************72
c
cc MAIN is the main program for MULTIGRID_POISSON_1D_PRB.
c
c  Discussion:
c
c    MULTIGRID_POISSON_1D_PRB tests the MULTIGRID_POISSON_1D library.
c
c  Licensing:
c
...
c
     ...
     &  '  MONOGRID_POISSON_1D solves a 1D Poisson BVP'
      ...
      do k = 5, 5
        ...
        call monogrid_poisson_1d ( n, a, b, ua, ub, force1, exact1, 
     &    it_num, u )
...
c
     ...
     &  '  MULTIGRID_POISSON_1D solves a 1D Poisson BVP'
      ...
      do k = 5, 5
        ...
        call multigrid_poisson_1d ( n, a, b, ua, ub, force1, 
     &    exact1, it_num, u )
...
c
     ...
     &  '  -u"(x) = - x * (x+3) * exp(x), for 0 < x < 1'
      ...
      do k = 5, 5
        ...
        call monogrid_poisson_1d ( n, a, b, ua, ub, force2, exact2, 
     &    it_num, u )
...
c
     ...
     &  '  -u"(x) = - x * (x+3) * exp(x), for 0 < x < 1'
      ...
      do k = 5, 5
        ...
        call multigrid_poisson_1d ( n, a, b, ua, ub, force2, exact2, 
     &    it_num, u )
