...
10      continue
      ...
      subroutine monogrid_poisson_1d ( n, a, b, ua, ub, force, exact, 
     &  it_num, u )
...
c
c    Input, double precision A, B, the endpoints.
c
c    Input, double precision UA, UB, the boundary values at the endpoints.
c
...
10    continue
      ...
      subroutine multigrid_poisson_1d ( n, a, b, ua, ub, force, exact, 
     &  it_num, u )
