...
c*********************************************************************72
c
cc MAIN is the main program for FEM2D_BVP_LINEAR.
c
c  Discussion:
c
c    FEM2D_BVP_LINEAR_PRB tests the FEM2D_BVP_LINEAR library.
c
c  Licensing:
c
...
c
     ...
     &      i, j, x(i), y(j), u(i,j), uexact, abs ( u(i,j) - uexact )
      ...
      call fem2d_h1s_error_linear ( nx, ny, x, y, u, exact_ux1, 
     &  exact_uy1, h1s )
