...
c
c    Input, external ZNAME, the user subroutine to evaluate Z(X,Y),
c    of the form SUBROUTINE ZFUNC(X,Y,Z).
c
      implicit none
...
c  Parameters:
c
c    Input, integer NCOLZ, NROWZ, the dimensions of the array.
c
c    Input, real ZARRAY(NROWZ,NCOLZ), the data.
c
      implicit none
...
c  Parameters:
c
c    Input, integer IXMAX, the requested width, in columns, of the 
c    output graph.  1 <= IXMAX <= 100.
c
