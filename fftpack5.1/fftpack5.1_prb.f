...
c*********************************************************************72
c
cc MAIN is the main program for FFTPACKS5.1_PRB.
c
c  Discussion:
c
c    FFTPACK5.1_PRB tests the FFTPACK5.1 library.
c
c  Licensing:
c
...
c
      ...
      integer lensav
      parameter ( lensav = 
     &  2 * n + int ( log ( real ( n ) ) / log ( 2.0E+00 ) ) + 4 )
      ...
      write ( *, '(a,i8)' ) '  Workspace size LENSAV = ', lensav
c
...
c
      ...
      integer lensav
      parameter ( lensav = 
     &    2 * l + int ( log ( real ( l ) ) / log ( 2.0E+00 ) ) 
     &  + 2 * m + int ( log ( real ( m ) ) / log ( 2.0E+00 ) ) 
     &  + 8 )
...
c
      ...
      integer lensav
      parameter ( lensav = 
     &  n + int ( log ( real ( n ) ) / log ( 2.0E+00 ) ) + 4 )
...
c
      ...
      integer lensav
      parameter ( lensav = 
     &        l + int ( log ( real ( l ) ) / log ( 2.0E+00 ) ) + 4
     &  + 2 * m + int ( log ( real ( m ) ) / log ( 2.0E+00 ) ) + 4
     &  +     m + int ( log ( real ( m ) ) / log ( 2.0E+00 ) ) + 4 )
...
c
      ...
      integer lensav
      parameter ( lensav = 
     &  n / 2 + n + int ( log ( real ( n ) ) / log ( 2.0E+00 ) ) + 4 )
...
c
      ...
      integer lensav
      parameter ( lensav = 
     &  n / 2 + n + int ( log ( real ( n ) ) / log( 2.0 ) ) + 4 )
