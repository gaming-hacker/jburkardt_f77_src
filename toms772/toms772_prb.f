...
c*********************************************************************72
c
cc MAIN is the main program for TOMS772_PRB.
c
c  Discussion:
c
c    TOMS772_PRB tests the TOMS772 library.
C
...
C
      DATA    LIN/1/,  LOUT/6/,  LPLT/3/,  LPLV/4/
C     OPEN (LOUT,FILE='stritest.out')
      OPEN (LPLT,FILE='stri.eps')
      OPEN (LPLV,FILE='svor.eps')
C
