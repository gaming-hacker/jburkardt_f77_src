...
c*********************************************************************72
c
cc I4CVV_IGET gets item J from row I in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
c
c  Licensing:
c
...
c
c    Input, integer A(MN), the cell array.
c
...
c    1 <= J <= NR(I).
c
c    Output, integer AIJ, the value of item A(I,J).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_IINC increments item J from row I in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    Input, integer MN, the size of the cell array.
c
c    Input/output, integer A(MN), the cell array.
c
c    Input, integer M, the number of rows in the array.
c
c    Input, integer ROFF(M+1), the row offsets.
...
c    1 <= J <= NR(I).
c
c    Input, integer DAIJ, the increment to the value of item A(I,J).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_INDX indexes item J from row I in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= J <= NR(I).
c
c    Output, integer K, the index of item A(I,J).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_ISET sets item J from row I in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= J <= NR(I).
c
c    Input, integer AIJ, the new value of item A(I,J).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_NGET gets N items JN(*) from rows IN(*) in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= JN(*) <= NR(IN(*)).
c
c    Output, integer VN(NN), the value of items A(IN(*),JN(*)).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_NINC increments items JN(*) from rows IN(*) in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= JN(*) <= NR(IN(*)).
c
c    Input, integer DVN(NN), the increments of items A(IN(*),JN(*)).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_NNDX index N items JN(*) from rows IN(*) in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= JN(*) <= NR(IN(*)).
c
c    Output, integer KN(NN), the indices of items A(IN(*),JN(*)).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_NSET sets items JN(*) from rows IN(*) in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= JN(*) <= NR(IN(*)).
c
c    Input, integer VN(NN), the new value of items A(IN(*),JN(*)).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_OFFSET determines the row offsets of an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c*********************************************************************72
c
cc I4CVV_PRINT prints an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c*********************************************************************72
c
cc I4CVV_RGET gets row I from an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= I <= M.
c
c    Output, integer AI(NR(I)), the value of A(I,*).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_RINC increments row I in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= I <= M.
c
c    Input, integer DAI(NR(I)), the increment for A(I,*).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_RNDX indexes row I from an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= I <= M.
c
c    Output, integer K, the index of the first element of row I.
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_RSET sets row I from an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c    1 <= I <= M.
c
c    Input, integer AI(NR(I)), the new value of A(I,*).
c
      implicit none
...
c*********************************************************************72
c
cc I4CVV_SIZE determines the size of an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "vector of vectors" of I4's.
...
c*********************************************************************72
c
cc R8CVV_IGET indexes item J from row I in an R8CVV.
c
c  Discussion:
c
c    An R8CVV is a "vector of vectors" of R8's.
...
c*********************************************************************72
c
cc R8CVV_NGET gets N items JN(*) from rows IN(*) in an R8CVV.
c
c  Discussion:
c
c    An R8CVV is a "vector of vectors" of R8's.
...
c*********************************************************************72
c
cc R8CVV_NINC increments items JN(*) from rows IN(*) in an R8CVV.
c
c  Discussion:
c
c    An R8CVV is a "vector of vectors" of R8's.
...
c*********************************************************************72
c
cc R8CVV_NNDX indexes N items JN(*) from rows IN(*) in an R8CVV.
c
c  Discussion:
c
c    An R8CVV is a "vector of vectors" of R8's.
...
c*********************************************************************72
c
cc R8CVV_NSET sets items JN(*) from rows IN(*) in an R8CVV.
c
c  Discussion:
c
c    An R8CVV is a "vector of vectors" of R8's.
...
c*********************************************************************72
c
cc R8CVV_RNDX indexes row I from an R8CVV.
c
c  Discussion:
c
c    An R8CVV is a "vector of vectors" of R8's.
...
c    1 <= I <= M.
c
c    Output, integer K, the index of the first element in row I.
c
      implicit none
