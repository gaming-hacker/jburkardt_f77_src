...
c  Discussion:
c
c    CELL_PRB tests the CELL library.
c
c  Licensing:
c
...
c
      ...
      write ( *, '(a)' ) 'TEST01'
      write ( *, '(a)' ) 
     &  '  Use a double precision cell array (vector of vectors) to'
      write ( *, '(a)' ) '  store rows 3:7 of Pascal''s triangle.'
...
c*********************************************************************72
c
cc TEST02 stores some of Pascal's triangle in an I4CVV.
c
c  Discussion:
c
c    An I4CVV is a "cell array vector of vectors" of I4's.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) 'TEST02'
      write ( *, '(a)' ) 
     &  '  Use an integer cell array (vector of vectors) to store'
      write ( *, '(a)' ) '  rows 3:7 of Pascal''s triangle.'
...
c
      ...
      write ( *, '(a)' ) ' '
      write ( *, '(a,i1,a,i1,a,i7)' ) '  A(', i, ',', j, ') = ', aij
c
c  Retrieve row 4:
c
      i = 4
