...
c*********************************************************************72
c
cc BALL01_MONOMIAL_INTEGRAL returns monomial integrals in the unit ball in 3D.
c
c  Discussion:
c
...
c
      ...
      subroutine ball01_sample ( n, seed, x )

c*********************************************************************72
c
cc BALL01_SAMPLE uniformly samples points from the unit ball in 3D.
c
c  Discussion:
c
...
c*********************************************************************72
c
cc BALL01_VOLUME returns the volume of the unit ball in 3D.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c  Parameters:
c
c    Output, double precision BALL01_VOLUME, the volume of the unit ball.
c
      implicit none
