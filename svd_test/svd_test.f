...
c*********************************************************************72
c
cc MAIN is the main program for SVD_TEST.
c
c  Discussion:
c
...
c
      ...
      call r8mat_svd_lapack ( m, n, a, u, s, v, lwork )
c
c  Print the SVD.
c
...
c
      ...
      subroutine r8mat_svd_lapack ( m, n, a, u, s, vt, lwork )

c*********************************************************************72
c
cc R8MAT_SVD_LAPACK gets the SVD of a matrix using a call to LAPACK.
c
c  Discussion:
c
