...
c*********************************************************************72
c
cc MAIN is the main program for LAPLACIAN_PRB.
c
c  Discussion:
c
c    LAPLACIAN_PRB tests the LAPLACIAN library.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc TEST01 tests L1DD and similar routines.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST02 tests L1DD_APPLY and similar functions.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c*********************************************************************72
c
cc TEST03 tests L1DD_EIGEN and similar routines.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) 'TEST03'
      write ( *, '(a)' ) 
     &  '  Compute eigen information for the Laplacian:'
...
c*********************************************************************72
c
cc TEST04 tests L1DD_INVERSE and similar routines.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      double precision h
      double precision l(n,n)
      double precision linv(n,n)
      integer test

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TEST04'
      write ( *, '(a)' ) 
     &  '  The inverse of a full-storage matrix is returned by:'
...
c*********************************************************************72
c
cc TEST05 tests L1DD_CHOLESKY and similar routines.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
      ...
      write ( *, '(a)' ) 'TEST05'
      write ( *, '(a)' ) 
     &  '  Compute upper Cholesky factors for the Laplacian:'
...
c*********************************************************************72
c
cc TEST06 tests L1DD_LU and similar routines.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
