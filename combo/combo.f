...
c    and by the routine to halt the computation.
c
      implicit none
...
c      3, you're done.  Cease calling the routine;
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
10      continue
        ...
        if ( rank_copy .lt. i4_choose ( x, k + 1 - i ) ) then
          x = x - 1
          go to 10
        end if
...
10      continue
        ...
        if ( i4_choose ( n - x, k - i ) .le. rank_copy ) then
...
10      continue
        ...
        if ( rank_copy .lt. i4_choose ( x, i ) ) then
          x = x - 1
          go to 10
        end if
...
c
c    Halt as soon as all items have been allocated.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
